    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    string degName=DegreeProgramUI.TakeDegree_Name();
                    StudentUI.viewStudentInDegree(degName);
                }
                else if (option == 6)
                {
                    string name = StudentUI.TakeStudent_Name();
